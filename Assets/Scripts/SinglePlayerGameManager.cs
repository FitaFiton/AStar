...
public class SinglePlayerGameManager : GameManager {
    ...
    protected override void Awake() {
        ...
        _graph.center = new Vector2(MapWidth / 2f - .5f, MapHeight / 2f - .5f);
        _graph.mapSize = new Vector2Int(MapWidth, MapHeight);
        ScanMap();
	...
	/// <summary>
    /// Se ejecuta cuando el jugador pulsa ESCAPE. Carga la escena del menú
    /// </summary>
